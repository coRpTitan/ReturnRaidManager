...
ReturnRaidManager = LibStub("AceAddon-3.0"):NewAddon("ReturnRaidManager", "AceConsole-3.0")
ReturnRaidManager:RegisterChatCommand("rrm", "ToggleUI")

function ReturnRaidManager:OnInitialize()
	...
	ReturnRaidManager.db = LibStub("AceDB-3.0"):New("ReturnRaidManagerDB", default)
